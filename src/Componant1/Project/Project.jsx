import projectImg from "/public/images/Componant1/project/project1.png";
import projectImg2 from "/public/images/Componant1/project/project2.png";
import projectImg3 from "/public/images/Componant1/project/project3.png";
import projectImg4 from "/public/images/Componant1/project/project4.png";

const Project = () => {
  return (
    <section className="bg-[url('/public/images/Componant1/project/project-bg.png')] bg-no-repeat bg-cover bg-center py-28 text-center">
