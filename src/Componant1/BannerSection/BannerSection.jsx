...
import videoLayer from "/public/images/Componant1/video-outline.png";
    ...
    <section className="">
      <div className="relative overflow-hidden">
        <div className="keen-slider relative " ref={sliderRef}>
          <div className="keen-slider__slide number-slide1 h-[800px] bg-[url('/public/images/Componant1/slider-1.jpg')] bg-no-repeat bg-cover bg-right-top md:bg-center">
          ...
          <div className="keen-slider__slide number-slide1 h-[800px] bg-[url('/public/images/Componant1/slider-2.jpg')] bg-no-repeat bg-cover bg-right-top md:bg-center">
            <div className="Container flex items-center justify-start h-full">
              <div className="w-[500px]  ">
                <p className="font-Lobster text-PrimaryColor-0 text-base md:text-lg lg:text-xl leading-8 mb-5">
                  Helping Today, Helping Tomorrow
