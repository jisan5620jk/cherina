...
import testiProfile from "/public/images/Componant1/people1.png";
import testiProfile2 from "/public/images/Componant1/people2.png";
...
const Testimonial = () => {
  ...
  return (
    <section className="py-28 bg-[url('/public/images/Componant1/testibg.jpg')] bg-center bg-cover relative z-[1] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[#142121] before:opacity-90 before:-z-[1]">
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-16">
          <div>
            <Swiper {...settings}>
              <SwiperSlide>
                <div className="bg-[url('/public/images/Componant1/download.jpg')] bg-left bg-cover group p-5 md:p-10 rounded-md relative mb-7 mt-[50px]">
