...
import iconOne from "/public/images/Componant1/theme-icon-1.png";
import iconTwo from "/public/images/Componant1/theme-icon-2.png";
import iconThree from "/public/images/Componant1/theme-icon-3.png";
...
const HelpTheme = () => {
  return (
    <section className="bg-[url('/public/images/Componant1/help-theme-bg.jpg')] bg-no-repeat bg-center bg-cover">
