...
import bannerShape from "/public/images/Componant1/banner/heart2.png";
...
const Banner = () => {
  ...
  return (
    <Swiper {...settings}>
      <SwiperSlide>
        <section className="bg-[url('/public/images/Componant1/banner/hero-bg3.png')] bg-center bg-cover h-[700px] md:h-[920px] w-full flex items-center justify-center">
      ...
      <SwiperSlide>
        <section className="bg-[url('/public/images/Componant1/banner/hero-bg4.png')] bg-center bg-cover  h-[700px] md:h-[920px] w-full flex items-center justify-center">
          <div className="Container flex flex-col items-center justify-center">
            <div>
              <img src={bannerShape} className="animate-zoomInOut" />
            </div>
