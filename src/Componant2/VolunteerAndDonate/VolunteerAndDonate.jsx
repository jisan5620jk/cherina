// import volunteer from "/public/images/Componant2/volunteer-bg.jpg";
// import donate from "/public/images/Componant2/donate-bg.jpg";

import donating from "/public/images/Componant2/donating.png";
import helpingHand from "/public/images/Componant2/helping-hand.png";
...
const VolunteerAndDonate = () => {
  return (
    <section
      className={`bg-[url('/public/images/Componant2/VolunteerAndDonate.jpg')] bg-no-repeat bg-center bg-cover `}
    >
