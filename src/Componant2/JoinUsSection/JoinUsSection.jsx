...
import joinUsImg from "/public/images/Componant2/join-us.png";
import shape from "/public/images/Componant2/shape.png";
import Button from "../Button/Button";
import { MdKeyboardDoubleArrowRight } from "react-icons/md";
const JoinUsSection = () => {
  return (
    <section className="bg-[url('/public/images/Componant2/join-us-bg.jpg')] bg-center bg-cover bg-no-repeat ">
        ...
        <div className="flex-1">
          ...
          <div className="mt-5 w-fit max-w-[580px] font-Manrope ">
            <h1 className="heading-main text-darkSlate">
              ...
              <span className="text-coral">Poor People</span>
            </h1>
            ...
            <div className="bg-[#fff2ed] px-[30px] py-[25px] rounded-md border-l-[5px] border-coral my-7">
              <p className="text-base sm:text-lg leading-7 text-darkSlate font-medium">
                Helped Fund <span className="text-coral">24,347</span> Projects
                in 250 Countries worldwide donated{" "}
                <span className="text-coral">5 Milion </span>Peoples
              </p>
            </div>
          </div>
          <div className="flex items-center justify-between 2xl:pr-24">
            <div className="mb-10">
              ...
              <p className="text-sm sm:text-base leading-7 text-dimGray flex items-center">
                <FaCheckCircle size={20} className="text-coral mr-[10px]" />
