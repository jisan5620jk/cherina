...
const FeatureMain = ({
  ...
  return (
    <div className="group flex flex-col text-center mb-7 md:mb-0 bg-white shadow-cases rounded-md overflow-hidden pt-[52px] pb-12 2xl:px-9 relative before:absolute before:top-0 before:left-1/2 before:w-0 before:h-[5px] before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:rounded-t-md hover:before:w-full hover:before:left-0">
