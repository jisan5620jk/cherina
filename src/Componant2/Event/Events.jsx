  ...
  return (
    <section className="py-28">
      ...
      <div className="xl:px-12">
        <Swiper {...settings}>
          <SwiperSlide>
            <div className="bg-[url('/public/images/Componant2/event/events1.jpg')] rounded-md bg-center bg-cover mt-28 group relative z-[1] before:absolute before:rounded-md before:w-full before:h-full before:bg-[#1cc5ee] before:opacity-80 before:-z-[1]">
          ...
          <SwiperSlide>
            <div className="bg-[url('/public/images/Componant2/event/events2.png')] rounded-md bg-center bg-cover mt-28 group relative z-[1] before:absolute before:rounded-md before:w-full before:h-full before:bg-PrimaryColor-0 before:opacity-80 before:-z-[1]">
              <div className="px-[20px] 2xl:px-[42px] pt-[42px] pb-9">
                <div className="flex gap-5 items-center">
          ...
          <SwiperSlide>
            <div className="bg-[url('/public/images/Componant2/event/events3.png')] rounded-md bg-center bg-cover mt-28 group relative z-[1] before:absolute before:rounded-md before:w-full before:h-full before:bg-SecondaryColor-0 before:opacity-80 before:-z-[1]">
              <div className="px-[20px] 2xl:px-[42px] pt-[42px] pb-9">
                <div className="flex gap-5 items-center">
